...
export declare type Params = CreateParams | CompareParams | PullParams | StatusParams | FreezeParams | PublishParams | UpdateParams | LinkParams | InitParams | UnpackParams | PushParams | VerifyParams | SetAdminParams | AddParams | SessionParams | BumpParams | RemoveParams | CheckParams | UnlinkParams | QueryDeploymentParams | TransferParams | BalanceParams | CallParams | SendTxParams | CompileParams;
