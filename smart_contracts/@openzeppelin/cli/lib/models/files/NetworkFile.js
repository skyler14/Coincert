...
class NetworkFile {
    ...
    getProxies({ package: packageName, contract, address, kind } = {}) {
        if (lodash_isempty_1.default(this.data.proxies))
            return [];
        const allProxies = lodash_flatmap_1.default(this.data.proxies || {}, (proxiesList, fullname) => lodash_map_1.default(proxiesList, proxyInfo => (Object.assign(Object.assign(Object.assign({}, naming_1.fromContractFullName(fullname)), proxyInfo), { kind: proxyInfo.kind || interfaces_1.ProxyType.Upgradeable }))));
